...
st.markdown("""
    <style>
    /* CSS NUKLIR: Set ke POPPINS dari Google Fonts */
...
st.markdown("""
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; flex-wrap: wrap; gap: 15px;">
        <div>
            <h1 style='color: #1e293b; font-size: 2.5rem; margin-bottom: 0; letter-spacing: -0.5px;'>✨ AR Matcher Pro</h1>
            <p style='color: #64748b; font-size: 1.05rem; margin-top: 5px; margin-bottom: 0; font-weight: 500;'>Bikin proses recon invoice lo secepat kilat. Tinggal sat-set, beres! 🚀</p>
        </div>
        <div style="text-align: right; background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(10px); padding: 10px 18px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 15px rgba(0,0,0,0.02); font-size: 0.85rem; color: #64748b;">
            ...
            <span style="font-weight: 400;">for</span> <b style="color: #1e293b; font-size: 0.9rem;">CV Trijayatama</b>
        </div>
    </div>
""", unsafe_allow_html=True)
